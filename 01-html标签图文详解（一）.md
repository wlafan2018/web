...
> 欢迎:happy:在GitHub上关注我，一起入门和进阶前端。

> 以下是正文。
>
> 参考资料:<https://www.w3school.com.cn/html/index.asp>
...
属性：
 - `align="属性值"`：对齐方式。属性值包括left、center 、right、justify。
 ...
 - 举例：
  ...
  <h3 align="center">This is a header</h3>
  <p align="right">This is a paragraph.</p>
  
  <div style="color:#00FF00">
    <h3 align="justify">This is a header</h3>
    <p>This is a paragraph.</p>
  </div>
  ...
  ![align](D:\搜狗高速下载\12.前端开发\Web-master\01-html\align.PNG)
...
![divspan](D:\搜狗高速下载\12.前端开发\Web-master\01-html\divspan.PNG)
...
![img效果](D:\搜狗高速下载\12.前端开发\Web-master\01-html\img效果.PNG)
...
<body>
<p>一幅图像：</p>
<img src="images/p51494320.jpg"  width="320px" height="228px"  alt="天门山索道全长7454米，高差1277米，是国内为数不多高差超过千米的索道之一，其中站到上站之间的局部斜度更高达37度，世界罕见。" />
</body>
</html>
```
效果：
...
![1](D:\搜狗高速下载\12.前端开发\Web-master\01-html\images\1.png)

2、`align="center"`：图片和文字水平方向上居中对齐。显示效果：

![2](D:\搜狗高速下载\12.前端开发\Web-master\01-html\images\2.png)

3、`align="top"`：图片与文字顶端对齐。显示效果：

![3](D:\搜狗高速下载\12.前端开发\Web-master\01-html\images\3.png)

4、`align="left"`：图片在文字的左边。显示效果：

![4](D:\搜狗高速下载\12.前端开发\Web-master\01-html\images\4.png)

5、`align="right"`：图片在文字的右边。显示效果：

![5](D:\搜狗高速下载\12.前端开发\Web-master\01-html\images\5.png)
...
![6](D:\搜狗高速下载\12.前端开发\Web-master\01-html\images\6.png)

，在图片上点击右键，选择`属性`，弹出属性面板：

![7副本](D:\搜狗高速下载\12.前端开发\Web-master\01-html\images\7副本.png)
